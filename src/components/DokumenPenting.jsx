...
function DokumenPenting() {
  ...
  const handleFileChange = (event) => {
    ...
    if (
      ...
      alert(
        'Format file tidak didukung. Gunakan PDF, Word, Excel, JPG, JPEG, atau PNG.'
      )
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.error(
        'Gagal menyimpan dokumen penting:',
        error
      )
  ...
  const handleDelete = (document) => {
    const confirmed =
      window.confirm(
        `Apakah Anda yakin ingin menghapus dokumen "${document.namaDokumen}"?`
      )
          ...
          <div className="modal">
            ...
            <div className="modal-header">
              ...
              <div>
                ...
                <h2>
                  {editingId !== null
                    ? 'Edit Dokumen Penting'
                    : 'Tambah Dokumen Penting'}
                </h2>
            ...
            <div className="modal-body">
              ...
              <div className="detail-profile">
                ...
                <div className="detail-avatar">
                  {getFileTypeLabel(
                    selectedDocument.fileExtension
                  )}
                </div>
